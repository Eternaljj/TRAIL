...
from models.trail import Trainer as TRAILTrainer
    ...
    def main(self):
        ...
        for p, vs in param.items():
            ...
            for i, v in enumerate(vs):
                ...
                if self.config['model_name'] != 'TRAIL':
                    raise ValueError(
                        'This curated package only supports model_name=TRAIL'
                    )
                trainer = TRAILTrainer(self.config, self.writer)
